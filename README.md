...
<p align="center">
  <a href="https://github.com/Ezra90/Pocket-Provisioner/releases/latest">
    <img src="https://img.shields.io/github/v/release/Ezra90/Pocket-Provisioner?label=Download&logo=android" alt="Download Latest Release">
  </a>
  <a href="https://github.com/Ezra90/Pocket-Provisioner/actions/workflows/build.yml">
    <img src="https://github.com/Ezra90/Pocket-Provisioner/actions/workflows/build.yml/badge.svg" alt="Build Status">
  </a>
...
Pre-built APKs are published automatically on every commit to `main` and for every tagged release.

**[➡️ Go to Releases page](https://github.com/Ezra90/Pocket-Provisioner/releases)**

| APK | Architecture | Use when |
|-----|-------------|----------|
| `app-arm64-v8a-release.apk` | 64-bit ARM | Most modern Android phones (recommended) |
| `app-armeabi-v7a-release.apk` | 32-bit ARM | Older Android phones |
| `app-x86_64-release.apk` | x86\_64 | Emulators / x86 devices |

> **Dev builds** are published as a rolling pre-release tagged `dev`. Stable releases are tagged `vX.Y.Z`.
>
> The app also supports **in-app updates** — tap **Check for Update** on the dashboard to download and install the latest build directly from within the app.
